...
static const int64 nTargetSpacing = 2.5 * 60; // Shavercoin: 2.5 minutes
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Shavercoin: increase each by adding 2 to bitcoin's value.
