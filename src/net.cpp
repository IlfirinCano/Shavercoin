...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Shavercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"shavercointools.com", "dnsseed.shavercointools.com"},
    {"shavercoinpool.org", "dnsseed.shavercoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"shavercointools.com", "testnet-seed.shavercointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Shavercoin is probably already running."), addrBind.ToString().c_str());
        else
